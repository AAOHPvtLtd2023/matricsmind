  ...
  return (
    <section className={cn('relative w-full overflow-hidden', className)}>
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          <h2 className="from-foreground/80 via-foreground to-foreground/80 dark:from-foreground/70 dark:via-foreground dark:to-foreground/70 mb-4 bg-gradient-to-r bg-clip-text text-3xl font-bold tracking-tight md:text-4xl lg:text-5xl text-[#fff]">
            {title}
          </h2>
          <p className="text-white md:text-lg">{subtitle}</p>
        </motion.div>
