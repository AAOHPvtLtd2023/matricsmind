              ...
              <div className="md:w-2/3 p-8 md:p-12">
                ...
                <div className="prose max-w-none text-gray-700 leading-relaxed mb-8">
                  <p className="text-lg mb-3">
                    With a passion for blending creativity and strategy,
                    Priyanka has transformed{" "}
                    <span className="font-bold text-gray-900">
                      Matrics Mind
                    </span>{" "}
                    into a results-driven creative agency that helps brands grow
                    and stand out in competitive markets.
                  </p>

                  <p className="text-lg mb-3">
                    Since its inception, she has led every project with a
                    marketing-first approach — crafting designs that not only
                    look stunning but also drive engagement, generate leads, and
                    boost brand visibility.
                  </p>

                  <p className="text-lg">
                    Her vision has positioned{" "}
                    <span className="font-bold text-gray-900">
                      Matrics Mind
                    </span>{" "}
                    as a go-to partner for businesses seeking creativity with
                    measurable impact.
                  </p>
                </div>
              ...
              <div className="md:w-1/3 p-8 flex items-center justify-center relative ">
                ...
                <div className="relative z-10 bg-white/20 backdrop-blur-md rounded-3xl p-3 border border-white/30 shadow-2xl transition-transform duration-500 ease-in-out hover:scale-105">
                  <div className="text-center">
                    <Image
                      src={girl} // must be inside /public
                      alt="Girl"
