...
export default function ServicePage() {
  return (
    <>
      <head>
        <title>
          Our Services | Web Development, SEO & Branding - Matrics Mind
        </title>
        <meta
          name="description"
      ...
      <section className="w-full">
        ...
        <div className="">
          <AdvertisementSectionComponent
            title="Tech Solution"
            description="We Build Tech That Connects People and Powers Growth"
          />
          <AdvertisementSectionComponent
            title="Brand Solution"
            description="Your Brand, Clearly Defined and Powerfully Delivered"
          />
          <AdvertisementSectionComponent
            title="Visual Solution"
            description=" Designs That Capture Eyes  — & Minds"
          />
        </div>
