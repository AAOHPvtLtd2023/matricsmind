            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="relative bg-[#1C3784] p-6 rounded-xl text-center flex-shrink-0 w-64 sm:w-72 hover:shadow-2xl group cursor-pointer transition-all duration-300 hover:scale-105 overflow-hidden"
                >
                  {/* Glow Background */}
